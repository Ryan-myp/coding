...
def main():
    ...
    cases = [
        ("ad-omnicampaign-integration-deep", "Omnicampaign集成"),
        ("ad-audience-targeting-deep", "人群定向策略"),
        ("ad-realtime-bidding-deep", "实时竞价实现"),
        ("ad-frequency-capping-deep", "频次控制策略"),
        ("ad-creative-optimization-deep", "创意优化"),
        ("ad-brand-safety-deep", "品牌安全"),
        ("ad-viewability-tracking-deep", "可见性追踪"),
        ("ad-currency-mapping-deep", "货币映射"),
    ]
    ...
    for filename, title in cases:
        ...
        if not file_path.exists():
            content = generate_ad_case(title, filename, "深度分析")
